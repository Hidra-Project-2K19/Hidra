...
.parallax
{
  ...
  background-image: url("img/rocketleague.jpg");
  min-height: 500px;
...
.parallax2
{
  background-image: url("img/rocektleague2.jpg");
  min-height: 500px;
  background-attachment: fixed;
  background-position: center;
  background-repeat: no-repeat;
  ...
  <body>
   <ul class="topnav">
    ...
    <?php include_once("conexao.php");
      ...
      $result_cursos = "SELECT * FROM catindie  WHERE id='$id_curso'";
    ...
    <?php while ($rows_cursos = mysqli_fetch_assoc($resultado_cursos)){ ?>
      ...
      <div class="boxtext">
        ...
        <hr>
        <h2 class="ti"><?php  echo utf8_encode($rows_cursos['descricaop']); ?></h2>
      </div>
    <?php ?>
      ...
      background-image: url('img/<?php echo $rows_cursos['caminho_img1']; ?>');
      min-height: 500px;
      background-attachment: fixed;
      background-position: center;
      background-repeat: no-repeat;
      ...
      .parallax2
      {
      background-image: url('img/<?php echo $rows_cursos['caminho_img2']; ?>');
      min-height: 500px;
      background-attachment: fixed;
      background-position: center;
      background-repeat: no-repeat;
...
<div class="boxtext">
    ...
    <h2 class="ti">PS4<h2>
  <a href="https://store.steampowered.com/app/252950/Rocket_League/"><button class="ti2" style="vertical-align:middle">Baixar</button></a>
</div>

<!-- Footer -->
<footer>
  <img src="img/HYDRA-WHITEE.png" class="logoF">
  <p>© 2019 Hydra Corporation. Todos os direitos reservados. Todas as marcas são propriedade dos deus respectivos donos nos EUA e em outros países. IVA incluso em todos os preços onde aplicável.</p>
</footer>
<!-- FIM/footer -->
