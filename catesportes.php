...
<!-- MenuBTN -->
   <div id="myNav" class="overlay">
    ...
    <a href="home.php"><img style="vertical-align: middle;" class="logo" src="img/HYDRA-WHITEE.png" alt="Hydra Games"></a>
      ...
      <li class="left"><a href="adicionarpesporte.php">adicionar</a></li>
    </ul>
  
<!-- FIM/Menu -->
<div class="catconteiner">
<h1 class="catjogo">Esportes</h1>
</div>
...
<?php include_once("conexao.php");
            $result_cursos = "SELECT * FROM catesporte";
          ...
          <div class="">
            <div class="card">
              <div class="card-image">
                <a href="catesporteprod.php?id_curso=<?php echo $rows_cursos['id']; ?>">
