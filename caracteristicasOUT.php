...
.parallax 
{
  ...
  background-image: url("img/outlast1.jpg");
  min-height: 500px; 
...
.parallax2 
{
  background-image: url("img/outlast2.jpg");
  min-height: 500px; 
  background-attachment: fixed;
  background-position: center;
  background-repeat: no-repeat;
...
<div class="boxtext">
    ...
    <h2 class="ti">Outlast 2 traz-te Sullivan Knoth e os seus seguidores, que abandonaram o nosso mundo cruel para fundar Temple Gate, uma cidade situada nas profundezas do deserto, longe da civilização. Knoth e o seu rebanho estão a preparar-se para as adversidades do fim dos tempos, e tu estás no centro do furacão.

Tu és Blake Langermann, um operador de câmara que trabalha com a sua esposa, Lynn. Sois ambos jornalistas de investigação, dispostos a correr riscos e ir até ao fundo para descobrir as histórias que mais ninguém se atreveria a investigar.<h2>
</div>
...
Outras observações: Targetting 720p @ 30 fps
<br>
<br>
RECOMENDADOS:
SO: Windows Vista / 7 / 8 / 10, 64-bits
...
Memória: 8 GB de RAM
Placa de vídeo: 1.5GB VRAM, NVIDIA Geforce GTX 660 / ATI Radeon HD 7850
DirectX: Versão 11
Armazenamento: 30 GB de espaço disponível
Placa de som: DirectX Compatible
Outras observações: Targetting 1080p @ 60 fps<h2>
  <a href="https://store.steampowered.com/app/414700/Outlast_2/"><button class="ti2" style="vertical-align:middle">Baixar</button></a>
</div>
