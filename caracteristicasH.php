...
.parallax 
{
  ...
  background-image: url("img/halo1.jpg");
  min-height: 500px; 
...
<div class="boxtext">
    ...
    <h2 class="ti">Halo 4 é um jogo eletrônico de tiro em primeira pessoa desenvolvido pela 343 Industries e publicado pela Microsoft Studios exclusivamente para o Xbox 360. Halo 4 é o primeiro de uma nova trilogia de jogos da série Halo, nomeada de "trilogia Reclaimer".<h2>
</div>
...
<div class="boxtext">
    ...
    <h2 class="ti"> X BOX<h2>
  <a href="https://www.microsoft.com/en-us/p/halo-4/c26xnflhtsgh"><button class="ti2" style="vertical-align:middle">Baixar</button></a>
</div>
