...
<h3 class="tip4">AAAAAAAAAAAAAAAAAAAAAAAAAAAAA<h3>
        <p>
             <p>AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA:
                <p>1) AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA</p>
                <p>2) AAAAAAAAAAAAAAAA</p>
                <p>3) AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA </p>
                <p>4) AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA.</p>
                <p>
                    <p>
                        <div class="card" id="card1">
                            <h3>1</h3>
                            <img src="img/" width="250px" height="300px"></a>
                        </div>
