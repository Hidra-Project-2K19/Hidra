...
<div id="myNav" class="overlay">
    ...
    <a href="home.php"><img style="vertical-align: middle;" class="logo" src="img/HYDRA-WHITEE.png" alt="Hydra Games"></a>
      ...
      <li class="left"><a href="adicionarpindie.php">adicionar</a></li>
    </ul>
  
<!-- FIM/Menu -->
<div class="catconteiner">
<h1 class="catjogo">Indie</h1>
</div>
...
<?php include_once("conexao.php");
            $result_cursos = "SELECT * FROM catindie";
          ...
          <div class="">
            <div class="card">
              <div class="card-image">
                <a href="catindieprod.php?id_curso=<?php echo $rows_cursos['id']; ?>">
  ...
  <a href="caracteristicasACBF.php"><h1>AC Black Flag</h1></a>
    ...
    <p>Disponível na Plataforma Hydra</p>
    <a href="dados2.php"><p><button>+ CARRINHO</button></p></a>
  </div>
  ...
  <div class="card" id="card6">
    ...
    <p>Disponível na Plataforma Hydra</p>
    <a href="dados.php"><p><button>+ CARRINHO</button></p></a>
  </div>
  ...
  <div class="card" id="card8">
    ...
    <p>Disponível na Plataforma Hydra</p>
    <p><button href="">+ CARRINHO</button></p>
  </div>
</div>
<!-- FIM/Cards -->
