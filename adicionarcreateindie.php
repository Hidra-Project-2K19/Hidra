...
if(isset($_POST['btn-cadastrar'])):
	...
	$sql = "INSERT INTO catindie (nomep, precop, descricaop, caminho_img, caminho_img1, caminho_img2) VALUES ('$nomep', '$precop', '$descricaop', '$caminho_img','$caminho_img1','$caminho_img2')";
